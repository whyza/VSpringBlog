<template>
  <div style="position: relative" id="comment">
    ...
    <commentEdit :parentId="parentId" :replyuserName="replyuserName" :isReply="isReply" @changeisReply="changeisReply"
                 @changeparentId="changeparentId" @changereplyuserName="changereplyuserName"/>
  </div>
</template>
